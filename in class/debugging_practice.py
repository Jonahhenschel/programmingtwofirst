"""
In this activity, we are going to be learning about the debugger, and then testing our debugging skills with some
practice problems. As you work through the problems, remove the multiline comments around the problem you want to
work on next, and add the multiline comments back to the previous problem so it's out of the way.
"""
"""
